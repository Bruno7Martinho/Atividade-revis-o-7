...
>Descrição:Calcular o consumo de combustível para uma determinada viagem. Criando Setters e Getters, criando método que calcula o consumo total para uma viagem, dado a distância
(passada como parâmetro) e método que estima o custo da viagem com base no preço do combustível (passado como parâmetro).
## 📌 Sobre o Projeto
